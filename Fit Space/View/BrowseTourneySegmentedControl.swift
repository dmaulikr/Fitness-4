//
//  BrowseTourneySegmentedControl.swift
//  Fit Space
//
...
public class BrowseTourneySegmentedControl : UIControl {
    ...
    {
        tapGestureRecogniser = UITapGestureRecognizer(target: self, action: #selector(BrowseTourneySegmentedControl.didTap(_:)))
